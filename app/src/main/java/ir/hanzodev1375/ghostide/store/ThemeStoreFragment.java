...
/** Store "Themes" tab hosted in the app module so previews can use the real code editor. */
public class ThemeStoreFragment extends Fragment {
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    searchLayout.setOnTextChangedListener(text -> viewModel.search(text == null ? "" : text));
  ...
  private void onThemeClick(ThemeItem theme, int position) {
    ...
    ThemeStorePreviewSheet.newInstance(theme)
        .show(requireActivity().getSupportFragmentManager(), "store_theme_preview");
  }
}

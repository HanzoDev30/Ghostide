...
public interface TerminalViewClient {
  ...
  /**
   * Called after a completion item is accepted and its suffix has been committed to the shell.
   *
   * @param item The item that was selected.
   */
  default void onCompletionSelected(com.termux.view.completion.TerminalCompletionItem item) {}

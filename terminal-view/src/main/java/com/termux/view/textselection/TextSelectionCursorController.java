        ...
        terminalView.startActionMode(
            new ActionMode.Callback2() {
              ...
              public void onGetContentRect(ActionMode mode, View view, Rect outRect) {
                int visualCol1 =
                    terminalView.mRenderer.translateLogicalToVisualColumn(
                        terminalView.mEmulator, mSelX1, mSelY1);
                int visualCol2 =
                    terminalView.mRenderer.translateLogicalToVisualColumn(
                        terminalView.mEmulator, mSelX2, mSelY2);
    ...
    if (handle == mStartHandle) {
      ...
      if (mSelY1 == mSelY2) {
        ...
        if (vSelX1 > vSelX2) {
          vSelX1 = vSelX2;
          mSelX1 =
              terminalView.mRenderer.translateVisualToLogicalColumn(
                  terminalView.mEmulator, vSelX1, mSelY1);
        }
      }
      ...
      if (mSelY1 == mSelY2) {
        ...
        if (vSelX1 > vSelX2) {
          ...
          mSelX2 =
              terminalView.mRenderer.translateVisualToLogicalColumn(
                  terminalView.mEmulator, vSelX2, mSelY2);
        }
      }

...
import irhanzodev1375.musicpreview.R;
...
public class PlayerToggle extends FrameLayout {
  ...
  private void init(Context context) {
    ...
    rts = ContextCompat.getDrawable(context, R.drawable.music_round_square_avd);
    ptr = ContextCompat.getDrawable(context, R.drawable.music_pause_avd);
    str = ContextCompat.getDrawable(context, R.drawable.music_scallop_avd);
    rtp = ContextCompat.getDrawable(context, R.drawable.music_resume_avd);
